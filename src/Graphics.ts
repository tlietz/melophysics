...
export class Graphics {
  ...
  constructor() {
    ...
    this.scene.addListener('onpointermove', (event) => {
      console.log(event)
    })
    ...
    this.viewport.on('pointermove', (event) => { console.log(this.viewport.toWorld(event.data.global)) })
  ...
  updatePositions(world: RAPIER.World) {
    world.forEachCollider((elt) => {
      ...
      // Translation from physics simulation to rendered world
      if (!!gfx) {
  ...
  addCollider(
    ...
    switch (collider.shapeType()) {
      ...
      case RAPIER.ShapeType.Ball:
        ...
        graphics.on('pointerdown', (e) => { handlePress(graphics, e, parent) });
        this.viewport.addChild(graphics);
        break;
